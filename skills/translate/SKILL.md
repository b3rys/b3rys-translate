---
name: translate
description: b3rys translate 크롬 확장을 GitHub에서 설치하고 API 키 설정·사용법까지 끝까지 안내한다. 사용자가 `/b3:translate`를 실행하거나, repo URL을 붙여넣거나, "b3rys 번역 확장 설치/사용법"을 요청하면 사용.
allowed-tools: Bash, Read, WebFetch
---

# b3rys translate — 설치 & 사용 가이드 (`/b3:translate`)
...
3. 번역 ON 상태로 다른 페이지로 이동하면 자동으로 계속 번역된다. 버튼을 다시 누르면 OFF.
